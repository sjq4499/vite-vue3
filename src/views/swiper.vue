  ...
  <div>
    <a-row type="flex" justify="center">
      <a-col :xs="0" :sm="0" :md="0" :lg="20" :xl="20" class="swiper_box">
        ...
        >
          <swiper-slide
            ><img class="my_swiper_imgs" src="../assets/img/xiaoyi1.jpg" alt=""
          /></swiper-slide>
          <swiper-slide
            ><img class="my_swiper_imgs" src="../assets/img/xiaoyi2.jpg" alt=""
          /></swiper-slide>
          <swiper-slide
            ><img class="my_swiper_imgs" src="../assets/img/xiaoyi3.jpg" alt=""
          /></swiper-slide>
          <swiper-slide
            ><img class="my_swiper_imgs" src="../assets/img/xiaoyi5.jpg" alt=""
          /></swiper-slide>
          <swiper-slide
            ><img class="my_swiper_imgs" src="../assets/img/xiaoyi6.jpg" alt=""
          /></swiper-slide>
        </swiper>
      </a-col>
    </a-row>
